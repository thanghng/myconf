return {
  {
    ...
    dependencies = {
      -- manage external tools such as LSP servers, DAP servers, linters and formatters
    ...
    config = function()
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          if client and client.server_capabilities.documentHighlightProvider then
            local highlight_augroup = vim.api.nvim_create_augroup("lsp-hight-config", { clear = false })
      ...
      vim.api.nvim_create_autocmd("LspDetach", {
        group = vim.api.nvim_create_augroup("lsp-detach-config", { clear = true }),
        callback = function(event)
          vim.lsp.buf.clear_references()
          vim.api.nvim_clear_autocmds({ group = "lsp-hight-config", buffer = event.buf })
        end,
      })
